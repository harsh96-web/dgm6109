...
// DATA SOURCE & SORTING
// ========================================
// Dataset: My personal fitness tracking from Lab 8 (Sept 25 - Oct 6, 2025)
// Source: Self-collected data on workout duration, sleep, protein intake, and restfulness
const dataset = [
...
// Array.sort() sorts data chronologically by date
// This enables the visualization to show training progression over time from Sept 25 to Oct 6
// Source: Adapted from class examples on date sorting (Week 7)
...
// Create SVG and position chart area
// Source: Class starter code for Lab 8 scatterplot
...
// SCALES
// ========================================
// Map data values to pixel positions and visual properties
...
// scaleSqrt makes bubble area (not radius) proportional to protein value
const rScale = d3.scaleSqrt().domain(d3.extent(dataset, d => d.protein)).range([7, 21]);
// Color scale maps restfulness (1-5) to red-to-green gradient
...
// Source: Class example from Lab 8
const tooltip = d3.select("body").append("div").attr("class", "tooltip");

// ========================================
// DATA POINTS
// ========================================
// Create bubble chart with hover interactions
// Source: Adapted from Lab 8 scatterplot starter code
svg.selectAll("circle.dot")
  ...
  .attr("opacity", 0.8)
  // Show tooltip and enlarge bubble on hover
  ...
  // Hide tooltip and restore bubble size
  .on("mouseout", (event, d) => {
